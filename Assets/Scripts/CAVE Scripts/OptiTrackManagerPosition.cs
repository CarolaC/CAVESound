...
public class OptiTrackManagerPosition : MonoBehaviour 
{
	public string myName;
	public float scale = 20.0f;
	private static OptiTrackManagerPosition instance;
	public Vector3 origin = Vector3.zero; // set this to wherever you want the center to be in your scene
	public static OptiTrackManagerPosition Instance
	{
		get { return instance; } 
	}
